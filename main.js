            ...
            function my_keydown(e) {
               keyPressed = e.keyCode;
                ...
                if (e.shiftKey == true && keyPressed == '80') {
                  console.log("Se presiona p y shift al mismo tiempo"); block_image_width = block_image_width + 10;
                ...
                if(keyPressed == '39') { right(); console.log("rigth"); }
                     ...
                     console.log("altura del bloque = " + block_image_height);
                      console.log("Cuando se presiona la flecha hacia abajo, X = " + player_x + " , Y = "+player_y);
                       canvas.remove(player_object);
                        ...
                        function left() { if(player_x >=0) { player_y = player_x - block_image_width;
                           console.log("altura del bloque = " + block_image_width);
                            console.log("Cuando se presiona la flecha hacia izquierda, X = " + player_x + " , Y = "+player_y);
                             canvas.remove(player_object);
                              ...
                              function right() { if(player_x <=850) { player_y = player_x + block_image_width;
                                 console.log("altura del bloque = " + block_image_width);
